...
- **11 screens** wired into one clickable prototype: Onboarding (sign-up),
  Sign in, Unlock, Verify identity, Home, Card, Pay, Send, Receive, Activity,
  Settings + Profile — every input check shown in its error state
- **45 components**, from primitives (`Text`, `Stack`, `Surface`) to product
